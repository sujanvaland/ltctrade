...
namespace SmartStore.Web.Controllers
{
	public class PMIPNHandlerController : PublicControllerBase
	{
		...
		public ActionResult IPN()
		{
			...
			strPASSPHRASE = pmSettings.PY_SecretKey;
			...
			struserid = (Request["username"] == null) ? "0" : Request["username"].ToString();
			...
			{
				var transaction = _transactionService.GetTransactionById(int.Parse(strWallet));
