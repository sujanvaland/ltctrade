...
namespace SmartStore.Web.Models.Customer
{
    ...
    public partial class RegisterModel : ModelBase
    {
		...
		[SmartResourceDisplayName("Account.Fields.SponsorId")]
		...
		[SmartResourceDisplayName("Account.Fields.SolidTrustPayAcc")]
		public string SolidTrustPayAcc { get; set; }
		[SmartResourceDisplayName("Account.Fields.BitcoinAddressAcc")]
		public string BitcoinAddressAcc { get; set; }
		[SmartResourceDisplayName("Account.Fields.PayeerAcc")]
		public string PayeerAcc { get; set; }
		[SmartResourceDisplayName("Account.Fields.PMAcc")]
		public string PMAcc { get; set; }
		[SmartResourceDisplayName("Account.Fields.PayzaAcc")]
		public string PayzaAcc { get; set; }
		[SmartResourceDisplayName("Account.Fields.AdvanceCashAcc")]
